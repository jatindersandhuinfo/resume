...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#0b0d0e] px-5 text-center text-white">
      ...
      <Link
        href="/"
        className="mt-8 inline-flex min-h-12 items-center justify-center rounded-full bg-[#d6ad63] px-7 text-sm font-semibold uppercase tracking-[0.14em] text-[#0b0d0e] transition hover:bg-white"
      >
        Back to Home
      </Link>
