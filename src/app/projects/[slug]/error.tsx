...
export default function ProjectError({
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-studio px-6 text-center">
      <p className="text-xs font-bold tracking-[0.35em] uppercase text-gold">Project Error</p>
      <h1 className="mt-4 font-bebas text-6xl text-white">Failed to Load Project</h1>
      <p className="mt-4 max-w-md text-sm text-white/50">
        This project couldn&apos;t be loaded. Try refreshing or go back to all projects.
      </p>
