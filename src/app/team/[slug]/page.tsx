...
export default async function TeamMemberPage({ params }: Props) {
 ...
 <a
 href="/#team"
 className="inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.12em] text-white/60 transition hover:text-gold"
 >
 ...
 <Link href="/#team" className="transition hover:text-gold">Team</Link>
 <span aria-hidden="true" className="text-white/20">›</span>
 ...
 {/* Bio */}
 <p className="mt-6-lg max-w-xl text-white/60">
 {member.bio}
 </p>
 ...
 <div
 className="rounded-2xl border border-white/[0.08] bg-surface p-7"
 >
 {/* Quick stats */}
 ...
 {/* Social links */}
 <p className="chapter-label mb-4 text-white/35">Connect</p>
 ...
 <p className="max-w-2xl text-white/60 lg:pt-10">
 ...
 const CardContent = (
 <div className="relative h-full overflow-hidden rounded-2xl border border-white/[0.08] bg-surface-alt transition duration-300 group-hover:border-white/20 group-hover:shadow-2xl group-hover:shadow-black/40">
 ...
 {/* Name */}
 <h3
 className="text-white transition-colors duration-200 group-hover:text-gold"
 ...
 <p className="chapter-label mb-4">The Team</p>
 ...
 className="group flex items-center gap-5 rounded-2xl border border-white/[0.08] bg-surface-alt p-6 transition duration-300 hover:border-black/20 hover:shadow-xl hover:shadow-black/30"
 >
 {/* Avatar */}
 {other.image ? (
 ...
 <p className="font-bold text-white transition-colors group-hover:text-gold">
 {other.name}
 </p>
 <p
 ...
 fill="none"
 aria-hidden="true"
 className="shrink-0 text-white/20 transition-colors group-hover:text-gold"
 >
 ...
 <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:px-10">
 <aside
 className="relative overflow-hidden rounded-2xl border border-[#f59e0b30] bg-surface p-10 sm:p-14"
 >
 <div
 aria-hidden="true"
 ...
 <a
 href={`mailto:${contact.email}`}
 className="inline-flex min-h-[52px] items-center justify-center rounded-full bg-gold px-7 text-sm font-semibold uppercase tracking-[0.14em] text-white transition hover:bg-white"
 >
 Get in Touch
 </a>
 <Link
 href="/#team"
 className="inline-flex min-h-[52px] items-center justify-center rounded-full border border-white/[0.08] px-7 text-sm font-semibold uppercase tracking-[0.14em] text-white transition hover:border-gold hover:text-gold"
 >
 View Full Team
 </Link>
 </div>
 ...
 <Link href="/" className="transition hover:text-gold">Back to Portfolio</Link>
 </p>
 </footer>
