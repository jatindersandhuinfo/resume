...
export default function TeamError({
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-studio px-6 text-center">
      <p className="text-xs font-bold tracking-[0.35em] uppercase text-gold">Team Error</p>
      <h1 className="mt-4 font-bebas text-6xl text-white">Failed to Load Profile</h1>
      <p className="mt-4 max-w-md text-sm text-white/50">
        This team member&apos;s profile couldn&apos;t be loaded.
      </p>
