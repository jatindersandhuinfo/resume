...
export default function AIBlogPost() {
  const relatedPosts = getRelatedPosts('ai-tools-productivity-business-growth')
 return (
 ...
 <BlogPostSchemas
        ...
        keywords="AI tools, productivity AI, business growth AI"
      />
