    ...
    <main className="min-h-screen bg-white dark:bg-[#0b0d0e] text-[#0b0d0e] dark:text-white">
      ...
      <article className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20 lg:py-28">
        ...
        <nav aria-label="Breadcrumb" className="mb-8 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-black/40 dark:text-white/40">
          ...
          <span aria-hidden="true">›</span>
          <span className="text-black/60 dark:text-white/60">SaaS Case Study</span>
        </nav>

        {/* Meta */}
        <p className="section-kicker mb-5 font-black text-[#d6ad63] uppercase tracking-[0.15em] text-xs">Case Study · Full Stack Development</p>
        ...
        <p className="mt-6 text-lg sm:text-xl leading-relaxed text-black/60 dark:text-white/60 font-medium">How I Built a Full-Stack SaaS with Next.js and Node.js</p>
        ...
        <div className="prose-content mt-10 space-y-12 text-[#0b0d0e] dark:text-white">
          ...
          <section id="why-tech-stack" className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2 mt-4">
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block">Next.js</span>
                <span className="text-xs text-black/60 dark:text-white/60">Powering a highly responsive, SEO-optimized frontend using React Server Components.</span>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block">Node.js / Express</span>
                <span className="text-xs text-black/60 dark:text-white/60">Running asynchronous, highly scalable REST API microservices for business logic.</span>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block">MongoDB</span>
                <span className="text-xs text-black/60 dark:text-white/60">NoSQL document store that offers schema flexibility and rapid indexing.</span>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block">Vercel & Cloudflare</span>
                <span className="text-xs text-black/60 dark:text-white/60">Instant edge deployment paired with global DDoS firewall and security shields.</span>
              </div>
            </div>
            ...
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70 italic mt-2 font-medium">
          ...
          <section id="planning" className="space-y-6">
            ...
            <div className="space-y-6">
              <div className="pl-4 border-l-2 border-[#d6ad63]/40">
                <h3 className="text-lg font-bold text-[#0b0d0e] dark:text-white">Defining User Roles</h3>
                ...
                <ul className="pl-4 list-disc text-xs text-black/60 dark:text-white/60 mt-2 space-y-1">
              ...
              <div className="pl-4 border-l-2 border-[#d6ad63]/40">
                <h3 className="text-lg font-bold text-[#0b0d0e] dark:text-white">Database Design</h3>
                <p className="text-sm text-black/65 dark:text-white/65 mt-1">
          ...
          <section id="frontend" className="space-y-4">
            ...
            <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] mt-4">
              <h3 className="text-sm font-bold text-[#d6ad63] mb-3">Component Architecture</h3>
              <p className="text-xs text-black/65 dark:text-white/65 mb-4">
...
└── common/      # Navbars, buttons, inputs, loading skeletons`}
          ...
          <section id="backend" className="space-y-4">
            ...
            <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-[#d6ad63]/5 border-l-4 border-l-[#d6ad63] mt-4">
              <h3 className="text-sm font-bold text-[#0b0d0e] dark:text-white mb-2">REST API Architecture</h3>
              <p className="text-xs text-black/65 dark:text-white/65 mb-3 leading-relaxed">
...
models/      # Mongoose schemas and indexes`}
          ...
          <section id="auth-security" className="space-y-4">
            ...
            <div className="grid gap-4 mt-4 sm:grid-cols-2">
              <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <h3 className="text-sm font-bold text-[#d6ad63]">JWT Authentication</h3>
              ...
              <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <h3 className="text-sm font-bold text-[#d6ad63]">Role-Based Access Control (RBAC)</h3>
                <p className="mt-2 text-xs text-black/60 dark:text-white/60 leading-relaxed">
          ...
          <section id="mongodb" className="space-y-4">
            ...
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70 mt-4 text-center font-medium">
          ...
          <section id="dashboard" className="space-y-4">
            ...
            <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] mt-4">
              <h3 className="text-sm font-bold text-[#d6ad63] mb-3">Key Dashboard Capabilities</h3>
              <ul className="pl-4 list-disc text-xs text-black/60 dark:text-white/60 space-y-2">
          ...
          <section id="performance" className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2 mt-4 text-xs">
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10">
                <span className="font-bold text-[#d6ad63] block mb-1">Code Splitting & Lazy Loading</span>
                <p className="text-black/65 dark:text-white/65">Components outside the viewport or complex analytics charts load on-demand, reducing initial JavaScript bundle size.</p>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10">
                <span className="font-bold text-[#d6ad63] block mb-1">Next.js Image Component</span>
                <p className="text-black/65 dark:text-white/65">Automatically resizes, compresses, and delivers modern WebP image assets directly from Vercel’s global CDN.</p>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10">
                <span className="font-bold text-[#d6ad63] block mb-1">Data Caching</span>
                <p className="text-black/65 dark:text-white/65">Stores slow, static resource queries inside secure RAM caches, preventing repetitive database calls.</p>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10">
                <span className="font-bold text-[#d6ad63] block mb-1">Bundle Compression</span>
                <p className="text-black/65 dark:text-white/65">Compresses responses using Gzip to minimize data load across mobile networks.</p>
              </div>
            </div>
          </section>
          ...
          <section id="deployment" className="space-y-4">
            ...
            <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] mt-4">
              <ul className="space-y-4 text-xs text-black/65 dark:text-white/65">
                <li>
                  <strong className="text-sm text-[#d6ad63] block">1. Frontend: Next.js on Vercel</strong>
                ...
                <li>
                  <strong className="text-sm text-[#d6ad63] block">2. Backend: Node.js on Scalable Instances</strong>
                ...
                <li>
                  <strong className="text-sm text-[#d6ad63] block">3. Routing & Security: Cloudflare Shield</strong>
            ...
            <div className="space-y-4 mt-4 text-xs">
              {[
                ...
                <div key={idx} className="flex gap-4 items-start pl-2">
                  ...
                  <div>
                    <h3 className="font-bold text-[#0b0d0e] dark:text-white">{lesson.title}</h3>
                    <p className="text-black/60 dark:text-white/60 mt-0.5 leading-relaxed">{lesson.text}</p>
                  </div>
                </div>
              ))}
            </div>
