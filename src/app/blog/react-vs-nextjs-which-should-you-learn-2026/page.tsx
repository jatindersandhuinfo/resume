...
export default function ReactVsNextjsBlogPost() {
  const relatedPosts = getRelatedPosts('react-vs-nextjs-which-should-you-learn-2026')
 return (
 ...
 <BlogPostSchemas
        ...
        keywords="React vs Next.js, learn React, learn Next.js, frontend development"
      />
