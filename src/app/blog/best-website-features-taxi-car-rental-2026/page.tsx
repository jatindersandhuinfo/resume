    ...
    <main className="min-h-screen bg-white dark:bg-[#0b0d0e] text-[#0b0d0e] dark:text-white">
      ...
      <article className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20 lg:py-28">
        ...
        <nav aria-label="Breadcrumb" className="mb-8 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-black/40 dark:text-white/40">
          ...
          <span aria-hidden="true">›</span>
          <span className="text-black/60 dark:text-white/60">Fleet Features</span>
        </nav>

        {/* Meta */}
        <p className="section-kicker mb-5 font-black text-[#d6ad63] uppercase tracking-[0.15em] text-xs">Fleet & Transportation Strategy</p>
        ...
        <p className="mt-6 text-lg sm:text-xl leading-relaxed text-black/60 dark:text-white/60 font-medium">Best Website Features for Taxi and Car Rental Businesses</p>
        ...
        <div className="prose-content mt-10 space-y-12 text-[#0b0d0e] dark:text-white">
          ...
          <section id="introduction" className="space-y-4">
            ...
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70 font-semibold text-red-500 dark:text-red-400">
          ...
          <section id="why-modern-website" className="space-y-4">
            ...
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70 mt-4 italic font-medium text-[#d6ad63] text-center">
          ...
          <section id="vehicle-selection" className="space-y-6">
            ...
            <div className="grid gap-4 mt-4 sm:grid-cols-2 text-xs">
              <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <h3 className="text-sm font-bold text-[#d6ad63] uppercase tracking-wider">Sedan / Economy</h3>
                <ul className="mt-2 text-black/60 dark:text-white/60 space-y-1">
              ...
              <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <h3 className="text-sm font-bold text-[#d6ad63] uppercase tracking-wider">Luxury SUV</h3>
                <ul className="mt-2 text-black/60 dark:text-white/60 space-y-1">
            ...
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70 mt-2 font-medium italic text-center">
          ...
          <section id="ai-features" className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2 mt-4 text-xs">
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10">
                <span className="font-bold text-[#d6ad63] block mb-1">Smart Dispatching</span>
                <p className="text-black/65 dark:text-white/65">AI engines assign drivers based on dynamic traffic, reducing fuel spend and wait times.</p>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10">
                <span className="font-bold text-[#d6ad63] block mb-1">AI Support Bots</span>
                <p className="text-black/65 dark:text-white/65">Resolves client booking modifications, fare estimations, and cancellation requests 24/7.</p>
              </div>
            </div>
          </section>
