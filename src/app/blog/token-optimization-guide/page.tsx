    ...
    <main className="min-h-screen bg-white dark:bg-[#0b0d0e] text-[#0b0d0e] dark:text-white">
      ...
      <article className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20 lg:py-28">
        ...
        <nav aria-label="Breadcrumb" className="mb-8 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-black/40 dark:text-white/40">
          ...
          <span aria-hidden="true">›</span>
          <span className="text-black/60 dark:text-white/60">Token Optimization</span>
        </nav>

        {/* Meta */}
        <p className="section-kicker mb-5 font-black text-[#d6ad63] uppercase tracking-[0.15em] text-xs">Deep Dive · AI Workflows & Prompt Engineering</p>
        ...
        <p className="mt-6 text-lg sm:text-xl leading-relaxed text-black/60 dark:text-white/60 font-medium">How to Structure AI Prompts and Coding Tasks for Maximum Efficiency</p>
        ...
        <div className="prose-content mt-10 space-y-12 text-[#0b0d0e] dark:text-white">
          ...
          <section id="what-are-tokens" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">What Are Tokens in AI Models?</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
            ...
            <div className="grid gap-4 mt-4 sm:grid-cols-2 text-xs font-mono">
              <div className="p-4 rounded border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <strong className="block text-[#d6ad63] mb-1">Plain Text Example:</strong>
                <span className="text-black/60 dark:text-white/60">Input: &quot;Hello world&quot;</span>
                <span className="block text-[10px] text-black/40 dark:text-white/40 mt-1">Processes as ~2 to 3 tokens depending on model encoding.</span>
              </div>
              <div className="p-4 rounded border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <strong className="block text-[#d6ad63] mb-1">Code Syntax Example:</strong>
                <span className="text-black/60 dark:text-white/60">Input: &quot;const userName = &apos;John&apos;;&quot;</span>
                <span className="block text-[10px] text-black/40 dark:text-white/40 mt-1">Consumes multiple tokens because each keyword, variable, symbol, and string contributes.</span>
              </div>
            </div>
          ...
          <section id="why-matters" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Why Token Optimization Matters</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
            ...
            <ul className="pl-5 list-disc text-xs sm:text-sm text-black/65 dark:text-white/65 space-y-1.5 mt-2">
          ...
          <section id="how-consume" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">How AI Models Consume Tokens</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
              Every interaction contains three major components that make up the total token weight:
            </p>
            <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] mt-4 space-y-4 text-xs">
              <div className="pl-3 border-l-2 border-[#d6ad63]">
                <strong className="text-xs text-[#d6ad63] block uppercase tracking-wider">User Prompt</strong>
                <p className="text-black/65 dark:text-white/65 mt-0.5">Your active instruction, files uploaded, and questions sent.</p>
              </div>
              <div className="pl-3 border-l-2 border-[#d6ad63]">
                <strong className="text-xs text-[#d6ad63] block uppercase tracking-wider">Context</strong>
                <p className="text-black/65 dark:text-white/65 mt-0.5">The previous messages, instructions, and file versions retained in the active thread.</p>
              </div>
              <div className="pl-3 border-l-2 border-[#d6ad63]">
                <strong className="text-xs text-[#d6ad63] block uppercase tracking-wider">Model Response</strong>
                <p className="text-black/65 dark:text-white/65 mt-0.5">The output text, explanation, and code blocks generated by the AI.</p>
              </div>
            </div>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70 mt-4 italic text-center text-xs font-semibold text-black/50 dark:text-white/50">
          ...
          <section id="waste-causes" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Common Causes of Token Waste</h2>
            <div className="grid gap-4 mt-6 sm:grid-cols-2 lg:grid-cols-3 text-xs">
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10">
                <strong className="font-bold text-[#d6ad63] block mb-1">Copy-Pasting Whole Projects</strong>
                <p className="text-black/60 dark:text-white/60 leading-relaxed">Pasting hundreds of files into a prompt when the issue lies inside a single route or component.</p>
              </div>
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10">
                <strong className="font-bold text-[#d6ad63] block mb-1">Repeating Context Rules</strong>
                <p className="text-black/60 dark:text-white/60 leading-relaxed">Repeatedly copy-pasting the same instructions, project descriptions, or guidelines in every message.</p>
              </div>
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10">
                <strong className="font-bold text-[#d6ad63] block mb-1">Unfocused, Vague Prompts</strong>
                <p className="text-black/60 dark:text-white/60 leading-relaxed">Asking general questions that result in long, off-topic chat cycles to clarify requirements.</p>
              </div>
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10">
                <strong className="font-bold text-[#d6ad63] block mb-1">Massive Chat Histories</strong>
                <p className="text-black/60 dark:text-white/60 leading-relaxed">Keeping a single conversation thread active for weeks, forcing the model to re-parse old content.</p>
              </div>
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10 sm:col-span-2 lg:col-span-2">
                <strong className="font-bold text-[#d6ad63] block mb-1">Requesting Excessive Outputs</strong>
                <p className="text-black/60 dark:text-white/60 leading-relaxed">Asking for verbose, step-by-step paragraphs when all you need is a quick function refactor or inline bug fix.</p>
              </div>
            </div>
          </section>

          <section id="context-windows" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Understanding Context Windows</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
            ...
            <blockquote className="border-l-4 border-[#d6ad63] pl-4 my-6 italic text-lg text-black/60 dark:text-white/60">
          ...
          <section id="tokens-costs-cooldowns" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">The Relationship Between Tokens, Costs, and Cooldowns</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="optimization-devs" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Token Optimization for Developers</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
            ...
            <div className="grid gap-4 mt-4 sm:grid-cols-2 text-xs">
              <div className="p-4 rounded-lg bg-red-500/5 border border-red-500/10">
                ...
                <p className="text-black/60 dark:text-white/60">"Analyze my entire application." [pasting 10 unrelated source code files]</p>
              </div>

              <div className="p-4 rounded-lg bg-[#d6ad63]/5 border border-[#d6ad63]/25">
                <span className="font-bold text-[#d6ad63] block mb-1">✓ Optimized Prompt</span>
                <p className="text-black/70 dark:text-white/70 font-semibold">
          ...
          <section id="structuring-tasks" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Structuring Coding Tasks Efficiently</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-5 text-xs text-center font-bold">
              <div className="p-3 border border-black/10 dark:border-white/10 rounded">Step 1: Schema Design</div>
              <div className="p-3 border border-black/10 dark:border-white/10 rounded">Step 2: Authentication</div>
              <div className="p-3 border border-black/10 dark:border-white/10 rounded">Step 3: RBAC setup</div>
              <div className="p-3 border border-black/10 dark:border-white/10 rounded">Step 4: API Controllers</div>
              <div className="p-3 border border-black/10 dark:border-white/10 rounded">Step 5: React Components</div>
            </div>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70 mt-4">
          ...
          <section id="breaking-projects" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Breaking Large Projects into Smaller Tasks</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="context-summaries" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">Using Context Summaries Instead of Full Histories</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
...
- Current Task: Refactor User Creation API for duplicate email checks`}
            ...
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70 italic text-center font-medium">
          ...
          <section id="reusable-templates" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">Creating Reusable Prompt Templates</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
...
Output: Highlight problems and return only the corrected function.`}
          ...
          <section id="optimizing-debugging" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Optimizing Debugging Requests</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="optimizing-reviews" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Optimizing Code Review Requests</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="avoiding-cooldowns" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Avoiding AI Cooldowns and Usage Limits</h2>
            <div className="p-5 rounded-lg border border-[#d6ad63]/20 bg-black/[0.02] dark:bg-white/[0.02] space-y-4 text-xs">
              <strong className="text-xs text-[#d6ad63] block uppercase tracking-wider">Strategies to bypass limits:</strong>
              <ul className="list-disc pl-4 space-y-1.5 leading-relaxed text-black/65 dark:text-white/65">
          ...
          <section id="best-practices" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/25 pb-2">Best Prompt Engineering Practices</h2>
          ...
          <section id="common-mistakes" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Common Token Optimization Mistakes</h2>
          ...
          <section id="advanced-strategies" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Advanced Strategies for AI Power Users</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="future" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/25 pb-2">Future of Token-Efficient AI Workflows</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
