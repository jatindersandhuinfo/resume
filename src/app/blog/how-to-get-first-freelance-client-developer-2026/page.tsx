    ...
    <main className="min-h-screen bg-white dark:bg-[#0b0d0e] text-[#0b0d0e] dark:text-white">
      ...
      <article className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20 lg:py-28">
        ...
        <nav aria-label="Breadcrumb" className="mb-8 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-black/40 dark:text-white/40">
          ...
          <span aria-hidden="true">›</span>
          <span className="text-black/60 dark:text-white/60">Freelance Strategy</span>
        </nav>

        {/* Meta */}
        <p className="section-kicker mb-5 font-black text-[#d6ad63] uppercase tracking-[0.15em] text-xs">Guide · Freelance & Client Acquisition</p>
        ...
        <p className="mt-6 text-lg sm:text-xl leading-relaxed text-black/60 dark:text-white/60 font-medium">How to Get Your First Freelance Client as a Developer: The Ultimate 2026 Guide</p>
        ...
        <div className="prose-content mt-10 space-y-12 text-[#0b0d0e] dark:text-white">
          ...
          <section id="introduction" className="space-y-4">
            ...
            <blockquote className="border-l-4 border-[#d6ad63] pl-4 my-6 italic text-lg text-[#d6ad63] font-semibold">
          ...
          <section id="why-struggle" className="space-y-4">
            ...
            <p className="body-copy leading-relaxed text-[#d6ad63] font-semibold text-center mt-4">
          ...
          <section id="build-skills" className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2 mt-4 text-xs">
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block mb-1">Frontend Development</span>
                <ul className="pl-4 list-disc text-black/60 dark:text-white/60 space-y-0.5">
              ...
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block mb-1">Backend Development</span>
                <ul className="pl-4 list-disc text-black/60 dark:text-white/60 space-y-0.5">
              ...
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block mb-1">Database Management</span>
                <ul className="pl-4 list-disc text-black/60 dark:text-white/60 space-y-0.5">
                  <li>MongoDB (NoSQL)</li>
              ...
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block mb-1">Deployment & Cloud</span>
                <ul className="pl-4 list-disc text-black/60 dark:text-white/60 space-y-0.5">
            ...
            <div className="space-y-4 mt-4 text-xs">
              {[
                ...
                <div key={idx} className="flex gap-4 items-start pl-2">
                  ...
                  <div>
                    <h3 className="font-bold text-[#0b0d0e] dark:text-white">{item.section}</h3>
          ...
          <section id="niche" className="space-y-4">
            ...
            <div className="grid gap-4 mt-4 sm:grid-cols-2 text-xs">
              <div className="p-4 rounded-lg bg-red-500/5 border border-red-500/10">
                ...
                <p className="text-black/60 dark:text-white/60 italic">"I build websites and apps."</p>
              </div>

              <div className="p-4 rounded-lg bg-[#d6ad63]/5 border border-[#d6ad63]/25">
                <span className="font-bold text-[#d6ad63] block mb-1">✓ Specialized Niche Pitch</span>
                <p className="text-black/70 dark:text-white/70 font-semibold italic">
          ...
          <section id="linkedin" className="space-y-4">
            ...
            <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] mt-4 space-y-3 text-xs">
              <p>
                <strong className="text-sm text-[#d6ad63] block">1. Professional Headline</strong>
                Avoid generic "Software Developer". Use descriptive headlines: <em>"Full-Stack Developer | Next.js | Node.js | SaaS & AI Systems"</em>.
              </p>
              <p>
                <strong className="text-sm text-[#d6ad63] block">2. High-Quality Profile Photo</strong>
                Use a clean, professional, high-contrast headshot with a clean background.
              </p>
              <p>
                <strong className="text-sm text-[#d6ad63] block">3. Detailed About Section</strong>
              ...
              <p>
                <strong className="text-sm text-[#d6ad63] block">4. Featured Projects</strong>
          ...
          <section id="platforms-tips" className="space-y-4">
            ...
            <div className="p-4 rounded-lg bg-[#d6ad63]/5 border border-[#d6ad63]/25 text-xs italic leading-relaxed text-black/75 dark:text-white/75">
            ...
            <ol className="mt-4 space-y-4 text-xs">
              {[
                ...
                <li key={idx} className="flex gap-4 items-start">
                  <span className="grid h-8 w-8 shrink-0 place-items-center rounded-full border border-black/10 dark:border-white/10 text-xs font-black text-[#d6ad63]">
                    {idx + 1}
                  </span>
                  <div>
                    <h4 className="text-sm font-bold text-[#0b0d0e] dark:text-white">{step.step}</h4>
                    <p className="text-xs text-black/60 dark:text-white/60 mt-1 leading-relaxed">{step.detail}</p>
                  </div>
                </li>
              ))}
            </ol>
          ...
          <section id="pricing" className="space-y-4">
            ...
            <div className="grid gap-3 my-6 sm:grid-cols-3 text-center text-xs">
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-[#d6ad63]/25">
                <span className="font-extrabold text-lg text-[#d6ad63] block">Landing Pages</span>
                <span className="text-xl font-bold text-white block my-1">$300 – $800</span>
                <span className="text-[10px] text-black/60 dark:text-white/60 block">1-3 dynamic pages</span>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-[#d6ad63]/25">
                <span className="font-extrabold text-lg text-[#d6ad63] block">Business Sites</span>
                <span className="text-xl font-bold text-white block my-1">$800 – $3,000</span>
                <span className="text-[10px] text-black/60 dark:text-white/60 block">Full SEO integrations</span>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-[#d6ad63]/25">
                <span className="font-extrabold text-lg text-[#d6ad63] block">Custom SaaS MVP</span>
                <span className="text-xl font-bold text-white block my-1">$3,000+</span>
                <span className="text-[10px] text-black/60 dark:text-white/60 block">Custom dynamic databases</span>
              </div>
            </div>
          </section>
          ...
          <section id="timeline" className="space-y-4">
            ...
            <div className="grid gap-3 my-6 sm:grid-cols-3 text-center text-xs">
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-[#d6ad63]/25">
                <span className="font-extrabold text-sm text-[#d6ad63] block uppercase tracking-wider">Month 1</span>
                <span className="text-xs text-black/60 dark:text-white/60 block mt-2">
                  Build your personal portfolio site, optimize your Upwork and LinkedIn profiles, and draft your core case studies.
                </span>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-[#d6ad63]/25">
                <span className="font-extrabold text-sm text-[#d6ad63] block uppercase tracking-wider">Month 2</span>
                <span className="text-xs text-black/60 dark:text-white/60 block mt-2">
                  Initiate daily cold outreach emails, bid on Upwork proposals, and engage in online networking circles.
                </span>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-[#d6ad63]/25">
                <span className="font-extrabold text-sm text-[#d6ad63] block uppercase tracking-wider">Month 3</span>
                <span className="text-xs text-black/60 dark:text-white/60 block mt-2">
