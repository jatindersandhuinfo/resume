...
export default function FreelanceBlogPost() {
 ...
 {/* Meta */}
 <p className="section-kicker mb-5 font-black text-[#f59e0b] uppercase tracking-[0.15em] text-xs">Guide · Freelance & Client Acquisition</p>
 ...
 <blockquote className="border-l-4 border-[#f59e0b] pl-4 my-6 italic text-lg text-[#f59e0b] font-semibold">
 ...
 <p className="body-copy leading-relaxed text-[#f59e0b] font-semibold text-center mt-4">
 ...
 <span className="font-bold text-[#f59e0b] block mb-1">Frontend Development</span>
 ...
 <div className="p-4 rounded-lg bg-black/[0.02] border border-black/5 dark:border-white/5">
 <span className="font-bold text-[#f59e0b] block mb-1">Backend Development</span>
 <ul className="pl-4 list-disc text-white/60 space-y-0.5">
 ...
 <div className="p-4 rounded-lg bg-black/[0.02] border border-black/5 dark:border-white/5">
 <span className="font-bold text-[#f59e0b] block mb-1">Database Management</span>
 <ul className="pl-4 list-disc text-white/60 space-y-0.5">
 <li>MongoDB (NoSQL)</li>
 ...
 <div className="p-4 rounded-lg bg-black/[0.02] border border-black/5 dark:border-white/5">
 <span className="font-bold text-[#f59e0b] block mb-1">Deployment & Cloud</span>
 <ul className="pl-4 list-disc text-white/60 space-y-0.5">
 ...
 <span className="font-bold text-[#f59e0b] block mb-1">✓ Specialized Niche Pitch</span>
 ...
 <p>
 <strong className="text-sm text-[#f59e0b] block">1. Professional Headline</strong>
 Avoid generic "Software Developer". Use descriptive headlines: <em>"Full-Stack Developer | Next.js | Node.js | SaaS & AI Systems"</em>.
 </p>
 <p>
 <strong className="text-sm text-[#f59e0b] block">2. High-Quality Profile Photo</strong>
 Use a clean, professional, high-contrast headshot with a clean background.
 </p>
 <p>
 <strong className="text-sm text-[#f59e0b] block">3. Detailed About Section</strong>
 ...
 <p>
 <strong className="text-sm text-[#f59e0b] block">4. Featured Projects</strong>
 ...
 <div className="p-4 rounded-lg bg-[#f59e0b]/5 border border-[#f59e0b]/25 text-xs italic leading-relaxed text-black/75 text-white/75">
 ...
 <span className="grid h-8 w-8 shrink-0 place-items-center rounded-full border border-white/[0.08] text-xs font-black text-[#f59e0b]">
 {idx + 1}
 </span>
 <div>
 ...
 <div className="p-4 rounded-lg bg-black/[0.02] border border-[#f59e0b]/25">
 <span className="font-extrabold text-lg text-[#f59e0b] block">Landing Pages</span>
 ...
 <div className="p-4 rounded-lg bg-black/[0.02] border border-[#f59e0b]/25">
 <span className="font-extrabold text-lg text-[#f59e0b] block">Business Sites</span>
 ...
 <div className="p-4 rounded-lg bg-black/[0.02] border border-[#f59e0b]/25">
 <span className="font-extrabold text-lg text-[#f59e0b] block">Custom SaaS MVP</span>
 ...
 <div className="grid gap-3 my-6 sm:grid-cols-3 text-center text-xs">
 <div className="p-4 rounded-lg bg-black/[0.02] border border-[#f59e0b]/25">
 <span className="font-extrabold text-sm text-[#f59e0b] block uppercase tracking-wider">Month 1</span>
 ...
 <div className="p-4 rounded-lg bg-black/[0.02] border border-[#f59e0b]/25">
 <span className="font-extrabold text-sm text-[#f59e0b] block uppercase tracking-wider">Month 2</span>
 <span className="text-xs text-white/60 block mt-2">
 Initiate daily cold outreach emails, bid on Upwork proposals, and engage in online networking circles.
 </span>
 </div>
 <div className="p-4 rounded-lg bg-black/[0.02] border border-[#f59e0b]/25">
 <span className="font-extrabold text-sm text-[#f59e0b] block uppercase tracking-wider">Month 3</span>
 <span className="text-xs text-white/60 block mt-2">
