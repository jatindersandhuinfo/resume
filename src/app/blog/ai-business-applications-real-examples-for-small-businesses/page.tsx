    ...
    <main className="min-h-screen bg-white dark:bg-[#0b0d0e] text-[#0b0d0e] dark:text-white">
      ...
      <article className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20 lg:py-28">
        ...
        <nav aria-label="Breadcrumb" className="mb-8 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-black/40 dark:text-white/40">
          ...
          <span aria-hidden="true">›</span>
          <span className="text-black/60 dark:text-white/60">AI Business</span>
        </nav>

        {/* Meta */}
        <p className="section-kicker mb-5 font-black text-[#d6ad63] uppercase tracking-[0.15em] text-xs">Guide · AI Business</p>
        ...
        <div className="prose-content mt-10 space-y-12 text-[#0b0d0e] dark:text-white">
          ...
          <section id="what-is-ai" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">What Is AI in Business?</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="why-using-ai" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Why Small Businesses Are Using AI</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="customer-support" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">1. AI-Powered Customer Support</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="content-creation" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">2. AI for Content Creation</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
            ...
            <ul className="pl-5 list-disc text-sm text-black/65 dark:text-white/65 space-y-2">
              <li>Blog articles</li>
          ...
          <section id="marketing" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">3. AI in Marketing</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="automation" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">4. AI for Business Automation</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="data-analysis" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">5. AI for Data Analysis</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="website-improvement" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">6. AI for Website Improvement</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="benefits-ai" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Benefits of AI for Small Businesses</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
            ...
            <div className="grid gap-4 mt-6 sm:grid-cols-2 text-xs">
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.01] dark:bg-white/[0.01]">
                <strong className="block text-[#d6ad63] mb-1">Productivity & Decisions</strong>
                <p className="text-black/60 dark:text-white/60">Increased productivity and faster decision-making across teams.</p>
              </div>
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.01] dark:bg-white/[0.01]">
                <strong className="block text-[#d6ad63] mb-1">Customer Experience</strong>
                <p className="text-black/60 dark:text-white/60">Better customer experiences with 24/7 instant response support systems.</p>
              </div>
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.01] dark:bg-white/[0.01]">
                <strong className="block text-[#d6ad63] mb-1">Operational Costs</strong>
                <p className="text-black/60 dark:text-white/60">Reduced operational costs through intelligent workflow automation.</p>
              </div>
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.01] dark:bg-white/[0.01]">
                <strong className="block text-[#d6ad63] mb-1">Marketing Efficiency</strong>
                <p className="text-black/60 dark:text-white/60">Improved marketing performance and more efficient general business workflows.</p>
              </div>
            </div>
          </section>

          <section id="challenges" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Challenges to Consider</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="getting-started" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Getting Started with AI</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
