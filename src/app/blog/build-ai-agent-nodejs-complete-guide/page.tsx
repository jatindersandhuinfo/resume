    ...
    <main className="min-h-screen bg-white dark:bg-[#0b0d0e] text-[#0b0d0e] dark:text-white">
      ...
      <article className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20 lg:py-28">
        ...
        <nav aria-label="Breadcrumb" className="mb-8 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-black/40 dark:text-white/40">
          ...
          <span aria-hidden="true">›</span>
          <span className="text-black/60 dark:text-white/60">AI Agents</span>
        </nav>

        {/* Meta */}
        <p className="section-kicker mb-5 font-black text-[#d6ad63] uppercase tracking-[0.15em] text-xs">Deep Dive · AI & Agentic Workflows</p>
        ...
        <p className="mt-6 text-lg sm:text-xl leading-relaxed text-black/60 dark:text-white/60 font-medium">Build an AI Agent with Node.js: Complete Guide</p>
        ...
        <div className="prose-content mt-10 space-y-12 text-[#0b0d0e] dark:text-white">
          ...
          <section id="what-is-agent" className="space-y-4">
            ...
            <div className="grid gap-4 mt-6 sm:grid-cols-2">
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10 text-xs">
                <span className="font-bold text-[#d6ad63] block mb-1">A Chatbot:</span>
              ...
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10 text-xs">
                <span className="font-bold text-[#d6ad63] block mb-1">An AI Agent:</span>
                <p className="text-black/60 dark:text-white/60 leading-relaxed">
            ...
            <div className="space-y-4 mt-4 text-xs">
              {[
                ...
                <div key={idx} className="flex gap-4 items-start pl-2">
                  ...
                  <div>
                    <h3 className="font-bold text-[#0b0d0e] dark:text-white">{item.area}</h3>
                    <p className="text-black/60 dark:text-white/60 mt-0.5 leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section id="architecture" className="space-y-4">
            ...
            <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] mt-4 space-y-4">
              <div className="pl-3 border-l-2 border-[#d6ad63]">
                <strong className="text-xs text-[#d6ad63] block uppercase tracking-wider">1. User Input Layer</strong>
                <p className="text-xs text-black/65 dark:text-white/65 mt-1">
              ...
              <div className="pl-3 border-l-2 border-[#d6ad63]">
                <strong className="text-xs text-[#d6ad63] block uppercase tracking-wider">2. Reasoning Engine</strong>
                <p className="text-xs text-black/65 dark:text-white/65 mt-1">
              ...
              <div className="pl-3 border-l-2 border-[#d6ad63]">
                <strong className="text-xs text-[#d6ad63] block uppercase tracking-wider">3. Memory Layer</strong>
                <p className="text-xs text-black/65 dark:text-white/65 mt-1">
              ...
              <div className="pl-3 border-l-2 border-[#d6ad63]">
                <strong className="text-xs text-[#d6ad63] block uppercase tracking-wider">4. Tool & Execution Layer</strong>
                <p className="text-xs text-black/65 dark:text-white/65 mt-1">
          ...
          <section id="tech-stack" className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2 mt-4 text-xs">
              <div className="p-4 rounded-lg bg-black/[0.01] dark:bg-white/[0.01] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block mb-1">Frontend Layer</span>
                <p className="text-black/60 dark:text-white/60">Next.js, React, and Tailwind CSS for designing premium, responsive dashboards and portal screens.</p>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.01] dark:bg-white/[0.01] border border-black/5 dark:bg-white/5">
                <span className="font-bold text-[#d6ad63] block mb-1">Backend Server</span>
                <p className="text-black/60 dark:text-white/60">Node.js and Express.js for compiling fast, highly concurrent API architectures and tool calling processes.</p>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.01] dark:bg-white/[0.01] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block mb-1">Database & Memory</span>
                <p className="text-black/60 dark:text-white/60">MongoDB or PostgreSQL for persisting session history matrices, user settings, and agent parameters.</p>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.01] dark:bg-white/[0.01] border border-black/5 dark:border-white/5">
                <span className="font-bold text-[#d6ad63] block mb-1">LLM APIs</span>
                <p className="text-black/60 dark:text-white/60">OpenAI (GPT-4o), Anthropic (Claude 3.5 Sonnet), or Google Gemini APIs as your core reasoning engines.</p>
              </div>
            </div>
          </section>
...
npm init -y`}
            ...
            <pre className="p-3 rounded bg-black/5 dark:bg-white/5 text-[11px] font-mono text-black/70 dark:text-white/70 overflow-x-auto leading-relaxed">
...
async function getAgentReasoning(prompt, history = []) {
  ...
  return response.choices[0].message.content;
          ...
          <section id="prompt-engineering" className="space-y-4">
            ...
            <div className="grid gap-4 mt-4 sm:grid-cols-2 text-xs">
              <div className="p-4 rounded-lg bg-red-500/5 border border-red-500/10">
                ...
                <p className="text-black/60 dark:text-white/60">"Analyze this code."</p>
                <p className="text-[10px] text-black/60 dark:text-white/60 mt-2">Yields generic, surface-level suggestions without structured severity layers.</p>
              </div>

              <div className="p-4 rounded-lg bg-[#d6ad63]/5 border border-[#d6ad63]/25">
                <span className="font-bold text-[#d6ad63] block mb-1">✓ Structured Prompt</span>
                ...
                <p className="text-[10px] text-black/65 dark:text-white/65 mt-2">Generates deeply technical, accurate, and drop-in code recommendations.</p>
              </div>
            </div>
          </section>
          ...
          <section id="memory-systems" className="space-y-4">
            ...
            <div className="grid gap-4 mt-4 sm:grid-cols-2">
              <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <h3 className="text-sm font-bold text-[#d6ad63]">Short-Term Memory</h3>
              ...
              <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <h3 className="text-sm font-bold text-[#d6ad63]">Long-Term Memory</h3>
                <p className="mt-2 text-xs text-black/60 dark:text-white/60 leading-relaxed">
          ...
          <section id="tool-calling" className="space-y-4">
            ...
            <ul className="pl-4 list-disc text-xs text-black/65 dark:text-white/65 space-y-1.5 mt-2">
            ...
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70 mt-3">
          ...
          <section id="reasoning" className="space-y-4">
            ...
            <div className="p-5 rounded-lg border border-[#d6ad63]/20 bg-black/[0.02] dark:bg-white/[0.02] mt-4">
              <strong className="text-xs text-[#d6ad63] block uppercase tracking-wider mb-2">Example User Query:</strong>
              <p className="text-xs text-black/70 dark:text-white/70 italic mb-4">
              ...
              <ol className="list-decimal pl-4 text-xs text-black/65 dark:text-white/65 space-y-1.5">
          ...
          <section id="use-cases" className="space-y-6">
            ...
            <div className="grid gap-4 mt-4 sm:grid-cols-3">
              <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <h3 className="text-sm font-bold text-[#d6ad63]">1. Customer Support</h3>
                <p className="mt-2 text-xs text-black/60 dark:text-white/60 leading-relaxed">
              ...
              <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <h3 className="text-sm font-bold text-[#d6ad63]">2. Lead Generation</h3>
                <p className="mt-2 text-xs text-black/60 dark:text-white/60 leading-relaxed">
              ...
              <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
                <h3 className="text-sm font-bold text-[#d6ad63]">3. SaaS Assistants</h3>
                <p className="mt-2 text-xs text-black/60 dark:text-white/60 leading-relaxed">
  ...
  "preferences": {
    ...
    "homeAddress": "123 Main St, London"
          ...
          <section id="performance-optimization" className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2 mt-4 text-xs">
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10">
                <span className="font-bold text-[#d6ad63] block mb-1">Caching Common Answers</span>
                <p className="text-black/65 dark:text-white/65">Stores predictable replies (such as operational hours) in memory caches to bypass LLM calls.</p>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10">
                <span className="font-bold text-[#d6ad63] block mb-1">Limiting History Context</span>
                <p className="text-black/65 dark:text-white/65">Pipes only the most recent conversation messages, keeping token usage low and API responses fast.</p>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10">
                <span className="font-bold text-[#d6ad63] block mb-1">Asynchronous Queues</span>
                <p className="text-black/65 dark:text-white/65">Routes slow operations through a background task manager (like BullMQ), preventing thread blocks.</p>
              </div>
              <div className="p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10">
                <span className="font-bold text-[#d6ad63] block mb-1">Efficient Prompts</span>
                <p className="text-black/65 dark:text-white/65">Drafts shorter, highly structured system prompts to reduce input tokens and lower transaction costs.</p>
              </div>
            </div>
          </section>
          ...
          <section id="deployment" className="space-y-4">
            ...
            <div className="p-5 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] mt-4">
              <ul className="space-y-4 text-xs text-black/65 dark:text-white/65">
                <li>
                  <strong className="text-sm text-[#d6ad63] block">1. Frontend UI: Next.js on Vercel</strong>
                  Gives you global edge caching, instant deployments, and automatic image optimizations.
                </li>
                <li>
                  <strong className="text-sm text-[#d6ad63] block">2. Express APIs: Node.js on Railway or AWS</strong>
                  Railway or AWS ECS clusters provide stable Docker deployments, environment managers, and automatic resource scaling.
                </li>
                <li>
                  <strong className="text-sm text-[#d6ad63] block">3. Memory Storage: MongoDB Atlas or Supabase</strong>
          ...
          <section id="future-agents" className="space-y-4">
            ...
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70 italic font-semibold text-[#d6ad63] text-center">
