...
export default function SmallBusinessWebsiteBlogPost() {
 ...
 {/* Meta */}
 <p className="section-kicker mb-5 font-black text-[#f59e0b] uppercase tracking-[0.15em] text-xs">Strategy · Business Growth</p>
 ...
 <span className="font-bold text-[#f59e0b] block mb-1">Example Lead Flow:</span>
 ...
 <span className="font-bold text-[#f59e0b] block mb-1">Owning a Website:</span>
