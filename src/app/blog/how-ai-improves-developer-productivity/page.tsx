    ...
    <main className="min-h-screen bg-white dark:bg-[#0b0d0e] text-[#0b0d0e] dark:text-white">
      ...
      <article className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20 lg:py-28">
        ...
        <nav aria-label="Breadcrumb" className="mb-8 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-black/40 dark:text-white/40">
          ...
          <span aria-hidden="true">›</span>
          <span className="text-black/60 dark:text-white/60">Developer Productivity</span>
        </nav>

        {/* Meta */}
        <p className="section-kicker mb-5 font-black text-[#d6ad63] uppercase tracking-[0.15em] text-xs">Guide · AI Productivity</p>
        ...
        <div className="prose-content mt-10 space-y-12 text-[#0b0d0e] dark:text-white">
          ...
          <section id="what-is-ai-dev" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">What Is AI-Assisted Development?</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="why-using-ai" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Why Developers Are Using AI</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="code-generation" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">1. Faster Code Generation</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="faster-learning" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">2. Faster Learning</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="better-debugging" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">3. Better Debugging</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="doc-generation" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">4. Documentation Generation</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="test-creation" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-[#d6ad63]/20 pb-2">5. Unit Test Creation</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="real-benefits" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Real-World Benefits</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
            ...
            <div className="grid gap-4 mt-6 sm:grid-cols-2 text-xs">
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.01] dark:bg-white/[0.01]">
                <strong className="block text-[#d6ad63] mb-1">Development Speed</strong>
                <p className="text-black/60 dark:text-white/60">Faster development cycles and reduced time-to-market.</p>
              </div>
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.01] dark:bg-white/[0.01]">
                <strong className="block text-[#d6ad63] mb-1">Less Repetitive Tasks</strong>
                <p className="text-black/60 dark:text-white/60">Reduced repetitive, boring manual work and boilerplates.</p>
              </div>
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.01] dark:bg-white/[0.01]">
                <strong className="block text-[#d6ad63] mb-1">Learning Curve</strong>
                <p className="text-black/60 dark:text-white/60">Improved learning speed when adopting new frameworks.</p>
              </div>
              <div className="p-4 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.01] dark:bg-white/[0.01]">
                <strong className="block text-[#d6ad63] mb-1">High-Quality Assets</strong>
                <p className="text-black/60 dark:text-white/60">Better documentation, automated tests, and increased general productivity.</p>
              </div>
            </div>
          </section>

          <section id="mistakes" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Common Mistakes</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
          ...
          <section id="best-practices" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Best Practices</h2>
          ...
          <section id="replace-developers" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight text-[#0b0d0e] dark:text-white border-b border-black/5 dark:border-white/5 pb-2">Will AI Replace Developers?</h2>
            <p className="body-copy leading-relaxed text-black/70 dark:text-white/70">
            ...
            <div className="p-5 my-6 rounded-lg border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] space-y-3">
              <span className="font-bold text-[#d6ad63] block">Businesses still need developers to:</span>
              <ul className="pl-4 list-disc text-xs text-black/65 dark:text-white/65 space-y-1">
