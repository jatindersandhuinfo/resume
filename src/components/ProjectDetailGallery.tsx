    ...
    <>
      ...
      <div>
        <div className="mb-5 flex items-center gap-3">
          ...
          />
          <p className="text-[0.65rem] font-bold uppercase tracking-[0.2em]" style={{ color: accentColor }}>Project Screenshots</p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {allMedia.map((src, i) => (
            <button
              ...
              className="group/thumb relative aspect-video overflow-hidden rounded-xl border border-white/[0.08] bg-white/[0.02] transition hover:border-white/20 hover:shadow-lg hover:shadow-black/20 focus:outline-none focus:ring-2 focus:ring-accent"
